...
> **Dokumen rujukan** (perhitungan lengkap & dapat diaudit): [kapasitas-sistem-staging-production.md](kapasitas-sistem-staging-production.md) · **Model perhitungan Excel** (formula interaktif): [perhitungan-kapasitas-anggaran-umrohlovers.xlsx](perhitungan-kapasitas-anggaran-umrohlovers.xlsx)
