...
Platform AdopTree World sudah selesai dibangun dan teruji end-to-end — web, aplikasi Android lapangan (Build 32), dan pembayaran Midtrans — namun **belum memiliki server untuk beroperasi**. Diajukan pengadaan **tiga server dedicated** (staging + production + **AI dedicated**) + langganan software pendukung, provisioning **Agustus 2026** — prasyarat first paying merchant (Q3) dan public launch H2 2026:
...
3. **Server AI dedicated** — seluruh beban AI/inference (analisis citra satelit Sentinel-2, deteksi pohon DeepForest, dan model AI berikutnya seperti validasi titik koordinat) berjalan di server khusus, terpisah dari jalur trafik publik — sesuai standar teknis internal (inferensi CPU-berat tidak boleh berbagi memori dengan aplikasi produksi)
...
| --- | --- | --- |
| Tahun 1 | Cloud (proposal ini, termasuk langganan strategis + VPS AI) | **Plafon Rp 140 jt** |
| Tahun 2 | Cloud, naik mengikuti trigger metrik | ≈ Rp 250 jt |
...
| | |
| --- | --- |
| **< 1 deal CSR** | Satu tahun infrastruktur lengkap (3 VPS termasuk AI dedicated) + seluruh langganan software ≈ sembilan persepuluh nilai satu paket CSR korporasi rata-rata (PRD §7.2: $10.000 ≈ Rp 160 juta) |
| **≈ 74% dari alokasi anggaran** | Rencana anggaran (PRD §14.4) menyediakan $12.000 ≈ Rp 190 juta untuk infrastruktur 2027 — plafon ini ≈ 74%-nya (realisasi proyeksi ≈ 67%) |
