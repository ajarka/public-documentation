...
> 📊 **Model perhitungan interaktif (Excel, formula hidup)**: [perhitungan-kapasitas-anggaran-adoptree.xlsx](perhitungan-kapasitas-anggaran-adoptree.xlsx) — ubah asumsi di sheet Asumsi, seluruh angka menghitung ulang.
>
...
2. **Setujui plafon anggaran infrastruktur 12 bulan pertama Rp 105 juta** (Agu 2026 – Jul 2027, staging + production + **seluruh langganan software** — Mapbox, **ArcGIS**, **AccuWeather**, email, **AI komersial (DeepSeek) + AI internal engineering (Claude/GPT)**, monitoring, CDN, storage, registry, domain — sudah termasuk buffer 10%). Realisasi proyeksi **≈ Rp 97 juta** (upgrade tier mengikuti trigger §6, perkiraan awal 2027); plafon menampung **skenario upgrade dini** (≈ Rp 103 juta) sehingga momentum launch tidak pernah menunggu persetujuan ulang. Empat langganan strategis (ArcGIS · AccuWeather · DeepSeek · AI internal) adalah keputusan founder 18 Jul 2026. Inventaris lengkap di §8.1, rincian di §8.3.
...
| --- | --- | --- | --- |
| **Launch** (≤ 2.000 akun) | Agu–Des 2026 | Staging 2 vCPU/4 GB + Production 4 vCPU/8 GB + seluruh software langganan (termasuk ArcGIS/AccuWeather/AI) | **Rp 4,8–7,0 jt** (realistis ~Rp 5,9 jt) |
| **Growth Y1** (hingga 25 rb akun) | 2027 | Staging + app node 8 vCPU/16 GB + DB node terpisah + seluruh software langganan | **Rp 7,0–11,8 jt** (realistis ~Rp 8,5 jt) |
| **Scale Y2** (hingga 120 rb akun) | 2028 | Staging + HA penuh: 2× app + LB + managed Postgres HA + replica + node ML + software | **Rp 14–29 jt** (realistis ~Rp 21 jt) |

**Uji kewajaran anggaran**: PRD §14.4 mengalokasikan biaya infrastruktur **$3.600 (≈ Rp 57 jt) untuk 2026** dan **$12.000 (≈ Rp 190 jt) untuk 2027**. Plafon 12 bulan pertama (Rp 105 jt) ≈ **55% alokasi 2027**; realisasi proyeksi (≈ Rp 97 jt) ≈ **51%** — proposal ini **bukan** batas atas budget, melainkan kebutuhan riil terhitung plus ruang skenario upgrade dini; sisa alokasi tetap tersedia tanpa perlu diajukan sekarang.
...
| **Software** | 6 | Tira AI komersial — **DeepSeek API** (multi-provider, switch runtime) | Usage-based, **cap harian fail-closed built-in**; V4 Flash $0,14/$0,28 per 1 jt token; + roadmap AI validasi koordinat | Rp 25–100 rb | Rp 100–500 rb | Rp 0,5–2 jt | §8.1 |
| **Software** | 6b | AI internal engineering — **Claude Code Max $200/bln** (rekomendasi CTO) | 1 seat; Y2: 1–2 seat | Rp 3,2 jt | Rp 3,2 jt | Rp 3,2–6,4 jt | §8.1 |
| **Software** | 6c | **ArcGIS Online** (Esri) — analisis GIS profesional & peta MRV | Creator $700–1.191/user/tahun (1 seat; Y2: 2 seat) — dibayar tahunan di muka | Rp 0,93–1,6 jt | Rp 0,93–1,6 jt | Rp 1,9–3,2 jt | §8.1 |
| **Software** | 6d | **AccuWeather API** — cuaca per lahan | Trial gratis → Standard $25/bln (225 rb calls) → Elite $500/bln | Rp 0–410 rb | Rp 410–800 rb | Rp 0,4–2 jt | §8.1 |
...
| **TOTAL** | | **Per bulan (rentang penuh)** | | **Rp 4,8–7,0 jt** | **Rp 7,0–11,8 jt** | **Rp 14–29 jt** | §8.2 |
| **TOTAL** | | **Per bulan (titik tengah realistis)** | | **~Rp 5,9 jt** | **~Rp 8,5 jt** | **~Rp 21 jt** | §8.2 |
...
| **Plafon 12 bulan pertama** (Agu 2026 – Jul 2027, termasuk buffer 10%) | **Rp 105 juta** — realisasi proyeksi ≈ Rp 97 jt; skenario upgrade dini ≈ Rp 103 jt (§8.3) |
| Proyeksi tahun 2028 (skala penuh) | ≈ Rp 165–350 jt/tahun (realistis ~Rp 250 jt) |
| Perbandingan terhadap alokasi budget PRD §14.4 | Plafon ≈ 55% alokasi 2027 ($12.000); realisasi proyeksi ≈ 51%; proyeksi 2028 < 60% alokasi 2028 ($36.000) |
...
| **Tira AI komersial — DeepSeek API** *(keputusan founder 18 Jul: komersial pakai DeepSeek — lebih murah; arsitektur multi-provider tetap, bisa switch runtime)* | Co-pilot merchant (create land/campaign), support 24/7, normalize-geo, species autofill; **roadmap: AI validasi titik koordinat dari kumpulan data verifikasi lapangan** (workload usage-based yang sama, di bawah cap yang sama) | V4 Flash: input $0,14/1 jt token (cache-miss; $0,0028 saat cache-hit), output $0,28/1 jt → ≈ Rp 12/percakapan Tira (vs Rp 50–300 pada asumsi provider lama — A11 direvisi); **cap harian fail-closed + per-identitas sudah built-in** | Rp 25–100 rb | Rp 100–500 rb | Rp 0,5–2 jt |
| **AI internal engineering — Claude Code Max** *(keputusan founder 18 Jul: GPT/Claude khusus internal engineering, bukan komersial; tier ditetapkan **Claude Max $200/bln** — rekomendasi CTO, kapasitas penuh untuk pola AI-augmented engineering yang terbukti membangun 40+ fase produk)* | Produktivitas pengembangan platform | **Claude Max $200/bln** (1 seat; Y2: 1–2 seat) | Rp 3,2 jt | Rp 3,2 jt | Rp 3,2–6,4 jt |
| **ArcGIS Online** — Esri *(permintaan founder 18 Jul)* | Analisis GIS profesional: pengelolaan boundary & data spasial lahan, analisis tutupan/kesesuaian, peta MRV kelas industri utk laporan ESG & mitra (KLH/registri karbon) — melengkapi Mapbox (peta web konsumen tetap Mapbox) | Creator user type (termasuk ArcGIS Pro Basic + 500 credits/tahun): $700–1.191/user/**tahun** (list price bervariasi region/reseller — anchor store resmi $1.191,46); Launch–Y1: 1 seat; Y2: 2 seat; kredit tambahan bila analisis imagery berat | Rp 0,93–1,6 jt | Rp 0,93–1,6 jt | Rp 1,9–3,2 jt |
| **AccuWeather API** *(permintaan founder 18 Jul)* | Data cuaca per lahan: dashboard merchant/corporate, perencanaan tanam & jadwal inspeksi, alert cuaca ekstrem lapangan | Limited Trial gratis (50 calls/hari, cukup utk dev) → **Standard $25/bln** (225 rb calls/bln, forecast 5 hari, overage $0,12/1.000) → paket lebih tinggi s.d. Elite $500/bln (2,4 jt calls, forecast 15 hari); kebutuhan riil kecil karena di-cache server-side per lahan per jam (100 lahan ≈ 72 rb calls/bln) | Rp 0–410 rb | Rp 410–800 rb | Rp 0,4–2 jt |
...
| **Subtotal software** | | | **Rp 4,2–5,8 jt** | **Rp 5,5–8,8 jt** | **Rp 8,7–18,6 jt** |

> Batas atas subtotal mengandaikan **semua** layanan menyentuh paket berbayar maksimalnya bersamaan — jarang terjadi. Nilai realistis (dipakai untuk proyeksi §8.3): Launch ~Rp 5,1 jt · Y1 ~Rp 5,8 jt · Y2 ~Rp 10,1 jt. Kenaikan dibanding revisi v1.5 berasal dari **empat langganan baru keputusan founder 18 Jul** (ArcGIS + AccuWeather + AI internal engineering; DeepSeek justru MENURUNKAN biaya AI komersial ±5–10× dibanding asumsi provider lama). Catatan kas: lisensi ArcGIS dibayar **tahunan di muka** (Rp 11–19 jt sekali di awal periode) — angka bulanan di tabel adalah amortisasinya.
>
...
| **Subtotal software** (§8.1 — termasuk ArcGIS, AccuWeather, AI sejak v1.6) | Rp 4,2–5,8 jt | Rp 5,5–8,8 jt | Rp 8,7–18,6 jt |
| **Total/bulan (rentang penuh)** | **Rp 4,8–7,0 jt** | **Rp 7,0–11,8 jt** | **Rp 14–29 jt** |
| **Titik tengah realistis** | **~Rp 5,9 jt** | **~Rp 8,5 jt** | **~Rp 21 jt** |
...
| Production launch + software, 5 bulan (Agu–Des 2026) | 5 × ~Rp 5,6 jt (Prod Tier 1 + software Launch — termasuk ArcGIS/AccuWeather/AI v1.6) | Rp 28,1 jt |
| Production growth Y1 + software, 7 bulan (Jan–Jul 2027) | 7 × ~Rp 8,2 jt (Prod Tier 2 + software Y1) | Rp 57,4 jt |
| One-time: hardening, drill restore, k6 gate go-live | jam kerja internal + Rp 0 lisensi | Rp 0 |
| Buffer 10% (fluktuasi kurs/harga/volume) | | Rp 8,9 jt |
| **Total proyeksi realisasi (base — upgrade mengikuti trigger, perkiraan Jan 2027)** | | **≈ Rp 97 jt** |
| **Skenario upgrade dini** — trigger terpicu Nov 2026 seiring lonjakan pasca-public-launch (3 bln launch + 9 bln growth) | 12×0,25 + 3×5,6 + 9×8,2 + buffer 10% | **≈ Rp 103 jt** |
| **PLAFON DIAJUKAN** (menampung base maupun skenario dini) | | **Rp 105 jt** |

> **Konteks**: satu paket CSR korporasi rata-rata di PRD §7.2 bernilai $10.000 (≈ Rp 160 jt) — plafon infrastruktur + seluruh langganan software setahun penuh ≈ **dua pertiga dari satu deal CSR**. Dibanding alokasi PRD §14.4 (infra 2026: $3.600 ≈ Rp 57 jt; 2027: $12.000 ≈ Rp 190 jt), plafon ini ≈ **55% ruang 2027** (realisasi proyeksi ≈ 51%) — sisanya tetap tersedia untuk sprint NFT (RPC berbayar), lonjakan tak terduga, dan environment tambahan, **tanpa perlu diajukan sekarang**. Kenaikan plafon dari Rp 50 jt (v1.5) → Rp 105 jt sepenuhnya berasal dari **empat langganan strategis keputusan founder 18 Jul** (AI internal engineering — Claude Max $200/bln ≈ Rp 38 jt/th · ArcGIS ≈ Rp 16 jt/th · AccuWeather ≈ Rp 5 jt/th · DeepSeek — yang terakhir justru menurunkan biaya AI komersial), bukan dari kenaikan biaya server. Prinsip pengendalian tetap berlaku: realisasi mengikuti trigger §6, dan bila mendekati plafon, pengeluaran berikutnya kembali dimintakan persetujuan.
...
| SDM operasional / on-call 24/7 (±0,5 FTE) | pekerjaan yang di cloud dikerjakan vendor: failover, penggantian hardware, patch — **dipenuhi dari roster [dok. SDM](anggaran-sdm-manpower.md) §7 (DevOps/SRE 2027 + Infra #2 2028); saat konsolidasi anggaran hitung sekali, di pos SDM** | Rp 5–8 jt |
...
| --- | --- | --- | --- |
| **Tahun 1** (Agu 2026 – Jul 2027) | Cloud — plafon proposal ini (termasuk langganan strategis v1.6) | **Rp 105 jt** (plafon; realisasi ≈ Rp 97 jt) | §8.3 |
| **Tahun 2** (Agu 2027 – Jul 2028) | Cloud — Growth → Scale mengikuti trigger + langganan strategis berjalan | **≈ Rp 225 jt** | Rp 180–270 jt |
| **Tahun 3** (Agu 2028 – Jul 2029) | Cloud berjalan + **CapEx on-premise + parallel run + cutover** + langganan strategis | **≈ Rp 525 jt** (cloud ±8 bln ≈ 136 + CapEx ≈ 230 + OpEx on-prem & parallel ≈ 46 + langganan ≈ 75 + buffer) | Rp 420–640 jt |
| **Total 3 tahun** | | **≈ Rp 855 jt** | Rp 700–1.010 jt |
| **Tahun 4+** (steady on-premise) | OpEx + amortisasi + langganan strategis | **≈ Rp 270 jt/tahun** — vs tetap cloud yang diproyeksikan > Rp 320–380 jt/tahun → **penghematan mulai tahun ke-4** | |

**Uji kewajaran**: total 3 tahun (≈ Rp 855 jt) ≈ **104% dari alokasi infrastruktur PRD §14.4 tiga tahun** (2026 $3.600 + 2027 $12.000 + 2028 $36.000 ≈ Rp 825 jt) — **sedikit melampaui alokasi lama** (selisih ≈ Rp 30 jt/3 th); kenaikan dari 79% (v1.5) sepenuhnya berasal dari empat langganan strategis keputusan founder 18 Jul (AI internal Claude Max + ArcGIS + AccuWeather ≈ Rp 60–75 jt per tahun). Konsekuensi jujur: alokasi infrastruktur PRD §14.4 perlu direvisi minor (+$2.000–2.500 untuk 3 tahun) ATAU selisihnya ditutup dari sisa pos lain — diputuskan stakeholder saat persetujuan. Catatan: langganan strategis bersifat OpEx yang tidak ikut hilang saat transisi on-premise — ia berjalan paralel di semua skema. Model interaktifnya ada di sheet **OnPremise** file Excel.
...
| A11 | Biaya AI per percakapan Tira | **≈ Rp 12** (DeepSeek V4 Flash — revisi v1.6; sebelumnya Rp 50–300 dgn provider lama) | Cap harian fail-closed membatasi eksposur maksimum per definisi; admin dapat menurunkan cap/switch provider tanpa deploy |
| A13 | Harga ArcGIS Creator (per user/tahun) | $700–1.191 (anchor store resmi $1.191,46) | List price bervariasi region/reseller; **wajib minta penawaran Esri Indonesia saat pengadaan**; program nonprofit Esri (bila entitas memenuhi syarat) memangkas drastis |
| A14 | AccuWeather paket | Standard $25/bln (225 rb calls) | Kebutuhan riil ditekan cache server-side per lahan per jam; naik paket hanya bila volume/fitur (15-day forecast) menuntut |
| A15 | AI internal engineering | **Claude Max $200/bln, 1 seat** (rekomendasi CTO) | Seat & tier ditinjau per kuartal mengikuti intensitas pengembangan |
...
| v1.5 | 2026-07-17 | **Dokumen pasangan SDM** ([anggaran-sdm-manpower.md](anggaran-sdm-manpower.md), permintaan founder 17 Jul: hitung manpower termasuk skenario on-premise + anggaran SDM menuju production): eksklusi (d) SDM kini terhitung penuh — roster 3 fase berbasis trigger, plafon SDM 12 bln Rp 1,5 M, plot gabungan SDM+infra 3 th ≈ Rp 8,9 M; §10.2 diberi rujukan anti-dobel-hitung (pos on-call = porsi 0,5 FTE roster SDM); sheet Excel **SDM** ditambahkan |
