...
| **Software** | 6e | **Google Workspace** — email domain tim + Drive/Docs/Meet | Business Starter $7/user/bln; seat = roster SDM (7→14→21) | Rp 0,45–0,78 jt | Rp 1,0–1,57 jt | Rp 1,57–2,35 jt | §8.1 |
...
| **Google Workspace** *(v1.6.2)* | Email domain profesional tim (`support@`/`privacy@`/`security@adoptreeworld.com` yang sudah tercantum di halaman legal platform — hari ini masih Gmail gratis) + Drive/Docs/Meet internal. **Berbeda dari Resend/SES** (pengiriman email transaksional otomatis) — ini mailbox manusia | **Business Starter $7/user/bln** (paket tahunan; flexible $8,40; 30 GB/user); seat mengikuti roster SDM: Launch 4–7 → Y1 9–14 → Y2 14–21 | Rp 0,45–0,78 jt | Rp 1,0–1,57 jt | Rp 1,57–2,35 jt |
...
| **Subtotal software** | | | **Rp 4,7–6,6 jt** | **Rp 6,5–10,4 jt** | **Rp 10,3–20,9 jt** |

> Batas atas subtotal mengandaikan **semua** layanan menyentuh paket berbayar maksimalnya bersamaan — jarang terjadi. Nilai realistis (dipakai untuk proyeksi §8.3): Launch ~Rp 5,9 jt · Y1 ~Rp 7,4 jt · Y2 ~Rp 12,5 jt. Kenaikan dibanding revisi v1.5 berasal dari **empat langganan baru keputusan founder 18 Jul** (ArcGIS + AccuWeather + AI internal engineering; DeepSeek justru MENURUNKAN biaya AI komersial ±5–10× dibanding asumsi provider lama). Catatan kas: lisensi ArcGIS dibayar **tahunan di muka** (Rp 11–19 jt sekali di awal periode) — angka bulanan di tabel adalah amortisasinya.
>
...
| A16 | Google Workspace | Business Starter $7/user/bln; seat = headcount roster SDM (7→14→21) | Naik ke Business Standard ($14) hanya bila butuh storage/recording besar; seat non-mailbox bisa dikurangi |
